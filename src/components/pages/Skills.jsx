            ...
            <section id="Skills">
                ...
                <div className="skillContainer">
                    <Grid container justifyContent="space-evenly">
                        ...
                        <Grid item>
                            <SkillCard
                                imageUrl="https://www.edureka.co/blog/wp-content/uploads/2017/05/AngularJS-logo-Deep-Dive-into-AngularJS-Edureka.png"/>
                        </Grid>
                        <Grid item>
                        ...
                        <Grid item>
                            <SkillCard
                                imageUrl="https://images.ctfassets.net/twhs6sq7mv9q/2ygKhYdEDj8QZYr5uBhKaH/886a99a220062bd712cadcdd46997518/sass-logo.jpg"/>
                        </Grid>
                        <Grid item>
                        ...
                        <Grid item>
                            <SkillCard
                                imageUrl="https://velog.velcdn.com/images/dohyunkim12/post/78dfde93-8259-49cd-bbe3-36d7828f6ba3/image.jpg"/>
                        </Grid>
                        <Grid item>
